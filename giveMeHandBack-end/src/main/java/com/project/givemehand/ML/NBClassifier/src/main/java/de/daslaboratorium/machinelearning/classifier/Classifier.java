 ...
 *            A category class
 */
public abstract class Classifier<T, K> implements de.daslaboratorium.machinelearning.classifier.IFeatureProbability<T, K>, java.io.Serializable {
     ...
     * they become too old.
     */
    private Queue<de.daslaboratorium.machinelearning.classifier.Classification<T, K>> memoryQueue;
    ...
    public void reset() {
        ...
        this.memoryQueue = new LinkedList<de.daslaboratorium.machinelearning.classifier.Classification<T, K>>();
    }
     ...
     * @return The weighed average probability.
     */
    public float featureWeighedAverage(T feature, K category, de.daslaboratorium.machinelearning.classifier.IFeatureProbability<T, K> calculator) {
     ...
     * @return The weighed average probability.
     */
    public float featureWeighedAverage(T feature, K category, de.daslaboratorium.machinelearning.classifier.IFeatureProbability<T, K> calculator, float weight) {
    ...
    public void learn(K category, Collection<T> features) {
        this.learn(new de.daslaboratorium.machinelearning.classifier.Classification<T, K>(features, category));
    }
     ...
     */
    public void learn(de.daslaboratorium.machinelearning.classifier.Classification<T, K> classification) {
        ...
        if (this.memoryQueue.size() > this.memoryCapacity) {
            de.daslaboratorium.machinelearning.classifier.Classification<T, K> toForget = this.memoryQueue.remove();
     ...
     */
    public abstract de.daslaboratorium.machinelearning.classifier.Classification<T, K> classify(Collection<T> features);
